...
### Backend (Python)
- **`server.py`**: Creat amb `http.server`, obre una API al port 7689. Detecta automàticament si ets a Windows o Linux per utilitzar els mètodes de lectura de sensors adequats (WMI/PowerShell en Windows i Thermal Zones en Linux).
